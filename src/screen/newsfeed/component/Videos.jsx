        ...
        <div className="row js-masonry" data-masonry="{ &quot;itemSelector&quot;: &quot;.grid-item&quot;, &quot;columnWidth&quot;: &quot;.grid-sizer&quot;, &quot;percentPosition&quot;: true }">
            ...
            <div className="media-grid">
                ...
                <div className="reaction">
                    <a href className="btn text-green"><i className="fa fa-thumbs-up" /> 46</a>
                    <a href className="btn text-red"><i className="fa fa-thumbs-down" /> 11</a>
                </div>
                <div className="user-info">
                    <img src="http://placehold.it/300x300" alt="user" className="profile-photo-sm pull-left" />
                    <div className="user">
                    <h6><a href className="profile-link">Julia Cox</a></h6>
            ...
            <div className="media-grid">
                ...
                <div className="media-info">
                <div className="reaction">
                    <a href className="btn text-green"><i className="fa fa-thumbs-up" /> 233</a>
                    <a href className="btn text-red"><i className="fa fa-thumbs-down" /> 30</a>
                </div>
                <div className="user-info">
                    <img src="http://placehold.it/300x300" alt="users" className="profile-photo-sm pull-left" />
                    <div className="user">
                    <h6><a href className="profile-link">Anna Young</a></h6>
                    <a className="text-green" href>Friend</a>
                    </div>
                </div>
                </div>
